...
getAccordionTitles.forEach((currenItem) => {
  currenItem.addEventListener("click", (event) => {
    if (currenItem.classList.contains("active")) {
      ...
      getAlreadyActiveClasses.forEach((currentActiveItem) => {
        ...
        console.log("from else block for each");
      });
